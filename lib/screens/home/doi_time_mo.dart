...
class ChangeOpeningTimePage extends StatefulWidget {
  final String time_mo;

  const ChangeOpeningTimePage({super.key, required this.time_mo});
  @override
  _ChangeOpeningTimePageState createState() =>
      _ChangeOpeningTimePageState(time_mo);
}

class _ChangeOpeningTimePageState extends State<ChangeOpeningTimePage> {
  DateTime _currentOpeningTime = DateTime.now();
  final String time_mo;

  _ChangeOpeningTimePageState(this.time_mo);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Đổi thời gian mở cửa'),
      ),
      body: Container(
